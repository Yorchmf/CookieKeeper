 ...
 * entire month has aged past [ComplyrProperties.Consent.retentionMonths]. This is the other half of the
 ...
 * the per-drop advisory lock (see [com.complyr.common.SchedulingConfig]).
 */
@Component
class ConsentEventPartitionReaper(
    ...
    /**
     * Daily cron entrypoint. Overridable via `complyr.consent.retention-drop-cron` (defaulted here so
