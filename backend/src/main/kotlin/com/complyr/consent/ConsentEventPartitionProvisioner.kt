 ...
 * [ComplyrProperties.Consent.partitionLookaheadMonths] future months; the wide buffer means even a
 ...
 * [com.complyr.common.SchedulingConfig] for why any shared-state `@Scheduled` job must leader-guard.)
 *
...
class ConsentEventPartitionProvisioner(
    ...
    /**
     * Nightly cron entrypoint. Overridable via `complyr.consent.partition-provision-cron` (defaulted
    ...
    companion object {
         ...
         * app takes (see [ConsentIdempotencyReaper], [com.complyr.scan.PublicScanReaper]).
         */
