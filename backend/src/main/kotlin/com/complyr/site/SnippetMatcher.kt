 ...
 *
 * ```html
 * <script async src="https://cdn.complyr.eu/v1.js" data-complyr="pk_…"></script>
 * ```
 *
...
object SnippetMatcher {
     ...
     *
     * [cdnHost] is the *host* of `complyr.cdn-base-url` — compared host-to-host so a CDN path or scheme
     * change doesn't invalidate every customer's installed snippet, while `evil.com/cdn.complyr.eu/v1.js`
     ...
     * `data:` URLs can embed `//cdn.complyr.eu/` in their opaque body while loading nothing at all.
     */
