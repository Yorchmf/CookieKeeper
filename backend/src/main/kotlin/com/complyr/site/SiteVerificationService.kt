 ...
 *  2. **A `_complyr.{domain}` TXT record** carrying the site key ([DnsTxtLookup]) — the fallback for
 ...
 * (in [com.complyr.scan.CrawlMode.QUICK], the same posture the anonymous free-scan funnel already
