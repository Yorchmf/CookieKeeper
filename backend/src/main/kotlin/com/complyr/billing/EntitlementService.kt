...
class EntitlementService(
    ...
    fun requireCanAddSite(userId: UUID) {
        ...
        // [com.complyr.account.AccountDeletionService]). A create that passed the JWT filter's tombstone
     ...
     * ([com.complyr.consent.ConsentEventPartitionReaper]) is deliberately tenant-blind and set to the LONGEST
    ...
    /**
     * Whether [ownerId]'s plan suppresses the "Powered by Complyr" attribution (widget banner and
