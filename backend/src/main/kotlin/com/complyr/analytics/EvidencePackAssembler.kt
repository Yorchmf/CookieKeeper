...
import com.complyr.analytics.dto.EvidenceAccount
import com.complyr.analytics.dto.EvidenceManifest
import com.complyr.analytics.dto.EvidenceScanReport
import com.complyr.analytics.dto.EvidenceSite
import com.complyr.auth.UserEntity
import com.complyr.banner.ConsentCategory
import com.complyr.consent.ConsentCsvExportService
import com.complyr.consent.dto.ConsentLogFilter
import com.complyr.policy.PolicyEntity
...
class EvidencePackAssembler(
    ...
    companion object {
        ...
        private const val RETENTION_NOTICE =
            "Consent events are append-only audit evidence retained under Complyr's retention policy (ADR-16). " +
