...
class OverviewRepository(
     ...
     * [com.complyr.scan.ComplianceAnalyzer]: a CLASSIFIED, non-essential cookie carrying neither `Secure`
     ...
     * [com.complyr.banner.ConsentCategory.NECESSARY] instead of drifting as a magic string.
     */
    fun cookieTotals(
     ...
     * [com.complyr.policy.PolicyRepository.findFirstBySiteIdAndPublishedAtIsNotNullOrderByVersionDesc],
     * batched.
     */
