...
/**
 * Read-only aggregation over the append-only [consent_events][com.complyr.consent.ConsentEventEntity] table for
 ...
 * [com.complyr.consent.ConsentEventLogFragmentImpl].
 */
@Repository
