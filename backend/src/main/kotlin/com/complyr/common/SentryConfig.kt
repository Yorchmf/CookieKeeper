 ...
 * [ComplyrProperties.Observability.Sentry] and attach a [SentryAppender] to the Logback root logger, so
...
class SentryConfig(
    ...
    override fun afterSingletonsInstantiated() {
        ...
        if (cfg.dsn.isBlank()) {
            log.info("Sentry disabled — no complyr.observability.sentry.dsn configured")
            return
        }
