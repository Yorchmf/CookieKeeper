 ...
 * [com.complyr.account.AccountEmailService.requestEmailChange]). [email] is therefore the pending address,
 ...
 * [com.complyr.auth.AuthService.confirmEmailChange]). [email] is the address that just lost the account.
