...
import com.complyr.billing.StripeGateway
...
class AccountDeletionService(
    ...
    private fun erase(
        ...
        // ([com.complyr.billing.EntitlementService.requireCanAddSite]). Without it a create racing this
    ...
    // Mirrors com.complyr.billing.EntitlementService.advisoryLockKey — the two MUST fold the user id the
     ...
     * [AccountPasswordService.unmatchableHash][com.complyr.account.AccountPasswordService.unmatchableHash].
     */
