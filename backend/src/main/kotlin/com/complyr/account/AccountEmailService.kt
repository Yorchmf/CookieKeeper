...
import com.complyr.auth.EmailAlreadyRegisteredException
...
import com.complyr.notify.EmailChangeRequested
 ...
 * [com.complyr.auth.AuthService.confirmEmailChange]. That split is the security property: a stolen session
...
class AccountEmailService(
     ...
     * [com.complyr.auth.AuthService.forgotPassword].
     */
    @Transactional
