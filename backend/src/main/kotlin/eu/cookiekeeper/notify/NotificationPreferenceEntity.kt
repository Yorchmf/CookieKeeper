 ...
 *
 * State updates are immutable `copy(...)` + save, matching [eu.cookiekeeper.billing.SubscriptionEntity] and
 * the rest of the codebase. There is no domain logic on the entity; the send/skip decision lives in the
 * caller ([eu.cookiekeeper.scan.ScanCompletionNotifier]) so this stays a plain persistence record.
 */
@Entity
