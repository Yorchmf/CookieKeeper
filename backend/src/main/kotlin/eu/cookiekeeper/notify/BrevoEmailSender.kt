 ...
 * `cookiekeeper.mail.provider=brevo`; locally [SmtpEmailSender] delivers to Mailpit instead. Exactly one of
 ...
 */
@Service
@ConditionalOnProperty(prefix = "cookiekeeper.mail", name = ["provider"], havingValue = "brevo")
class BrevoEmailSender(
    ...
    init {
        require(apiKey.isNotBlank()) {
            "cookiekeeper.mail.brevo.api-key (BREVO_API_KEY) must be set when cookiekeeper.mail.provider=brevo"
        }
    }
