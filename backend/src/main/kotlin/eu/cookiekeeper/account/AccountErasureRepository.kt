...
interface AccountSiteErasureRepository : Repository<UserEntity, UUID> {
     ...
     * ([eu.cookiekeeper.site.SiteRepository.acquireUserSiteLock], and through it
     * [eu.cookiekeeper.billing.EntitlementService.requireCanAddSite]) — declared again here so the erasure
