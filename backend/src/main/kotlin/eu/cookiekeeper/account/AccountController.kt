...
import eu.cookiekeeper.account.dto.AccountExport
import eu.cookiekeeper.account.dto.ChangePasswordRequest
import eu.cookiekeeper.account.dto.DeleteAccountRequest
import eu.cookiekeeper.account.dto.NotificationPreferencesResponse
import eu.cookiekeeper.account.dto.RequestEmailChangeRequest
import eu.cookiekeeper.account.dto.RevokeAllSessionsRequest
import eu.cookiekeeper.account.dto.UpdateNotificationPreferencesRequest
import eu.cookiekeeper.account.dto.UpdateProfileRequest
import eu.cookiekeeper.auth.AuthCookieFactory
...
/**
 * The customer's own GDPR rights over their CookieKeeper account: Art. 20 portability and Art. 17 erasure
