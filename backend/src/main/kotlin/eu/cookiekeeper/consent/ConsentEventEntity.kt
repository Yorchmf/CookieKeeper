 ...
 * only writer that removes rows. No raw IPs (see [eu.cookiekeeper.common.IpHasher]) and no raw
...
interface ConsentEventRepository :
     ...
     * consent-usage meter ([eu.cookiekeeper.billing.EntitlementService.summarize]). A COUNT is a read, so
