 ...
 *
 * State transitions are applied immutably via `copy(...)` + save (mirrors [eu.cookiekeeper.site.SiteEntity]),
...
interface ScanRepository : JpaRepository<ScanEntity, UUID> {
     ...
     * [ScanRequestService]. Copied from [eu.cookiekeeper.site.SiteRepository.acquireUserSiteLock]: the lock
     ...
     * up behind the first. Mirrors [eu.cookiekeeper.scan.PublicScanRepository.tryAcquireAdvisoryXactLock].
     */
