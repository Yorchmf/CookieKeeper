 ...
 *
 * The policy is driven by the `cookiekeeper.cors` tree ([CookieKeeperProperties.Cors]) — when those
...
class CorsConfig {
    @Bean
    fun publicWidgetCorsSource(properties: CookieKeeperProperties): CorsConfigurationSource {
