...
/**
 * The five product languages CookieKeeper supports from day one (CLAUDE.md #6), as stable lowercase
 * ISO-639-1 codes — the same wire identifiers used by banner configs, policies, and consent events.
 * The single source of truth other locale helpers (e.g. [eu.cookiekeeper.policy.PolicyLanguages]) delegate to.
 */
