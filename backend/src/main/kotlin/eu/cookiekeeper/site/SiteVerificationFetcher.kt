...
import eu.cookiekeeper.scan.ScanCrawlPolicy
 ...
 * (ADR-17). This is the only place CookieKeeper makes an app-initiated request to a *customer-controlled*
 ...
 *  6. The body is read into a [CookieKeeperProperties.Verification.maxBodyBytes] cap and truncation is
...
class SiteVerificationFetcher(
    ...
    private companion object {
        ...
        const val USER_AGENT = "ComplyrVerifier/1.0 (+https://cookiekeeper.eu)"
