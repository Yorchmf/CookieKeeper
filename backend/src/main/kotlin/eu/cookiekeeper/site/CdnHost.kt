...
/**
 * The host of `cookiekeeper.cdn-base-url`, resolved once at startup — the value [SnippetMatcher] compares a
 ...
 * different things: `https://cdn.cookiekeeper.eu@evil.example.com/` has a *host* of `evil.example.com`. The
...
class CdnHost(
    ...
    /** The lowercased host, e.g. `cdn.cookiekeeper.eu`. */
