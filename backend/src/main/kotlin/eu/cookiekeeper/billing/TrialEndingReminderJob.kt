 ...
 * commit [eu.cookiekeeper.scan.ScheduledRescanJob] and [StripeWebhookReaper] use. A batch-wide transaction
...
class TrialEndingReminderJob(
    ...
    companion object {
         ...
         * [eu.cookiekeeper.scan.PublicScanReaper] 7_213_884_559, [StripeWebhookReaper] 8_431_907_662,
         * `ConsentIdempotencyReaper` 4_827_913_006, `ConsentEventPartitionReaper` 5_902_447_183,
         * [eu.cookiekeeper.scan.ScheduledRescanJob] 6_538_192_074, `ConsentEventPartitionProvisioner`
         * 6_401_558_237.
         */
